...
const Cesta = ({ onClick, name, imgUrl, price, removeItem, style, image1, priceWithIva, marca, modelo, pantalla }) => {
    ...
    } if (credentials?.user.name && !image1) {
    ...
    if (credentials?.user.name && image1 && !marca) {
        ...
        return (
            ...
            <div className="vista-cesta-container">
                ...
                <div className="contenedor-imagen-titulo-articulo-precio">
                    ...
                    <div className="vista-imagen-productos">
                        <img className="vista-imagen-productos" src={image1} alt={name} />
                    </div>
        ...
        return (
            ...
            <div className="vista-cesta-container">
                ...
                <div className="contenedor-imagen-titulo-articulo-precio">
                    ...
                    <div className="vista-imagen-productos">
                        <img className="vista-imagen-productos" src={image1} alt={marca} />
                    </div>
